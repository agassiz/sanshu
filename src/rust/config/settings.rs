...
pub fn default_custom_prompts() -> Vec<CustomPrompt> {
    vec![
        ...
        CustomPrompt {
            ...
            template_true: Some("✔️ 帮我生成总结性Markdown文档".to_string()),
            template_false: Some("❌ 不要生成总结性Markdown文档".to_string()),
            current_state: false,
            linked_mcp_tool: None,
        },
        CustomPrompt {
            ...
            template_true: Some("✔️ 帮我生成测试脚本".to_string()),
            template_false: Some("❌ 不要生成测试脚本".to_string()),
            current_state: false,
            linked_mcp_tool: None,
        },
        CustomPrompt {
            ...
            template_true: Some("✔️ 帮我编译".to_string()),
            template_false: Some("❌ 不要编译，用户自己编译".to_string()),
            current_state: false,
            linked_mcp_tool: None,
        },
        CustomPrompt {
            ...
            template_true: Some("✔️ 帮我运行".to_string()),
            template_false: Some("❌ 不要运行，用户自己运行".to_string()),
            current_state: false,
            linked_mcp_tool: None,
        },
        // MCP 功能性工具联动 prompt
        CustomPrompt {
            ...
            template_true: Some("✔️ 使用 sou 进行代码语义搜索，根据结果到指定位置查看更多上下文".to_string()),
        ...
        CustomPrompt {
            ...
            template_true: Some("✔️ 使用 context7 查询框架/库的最新官方文档和 API 用法".to_string()),
            template_false: Some("".to_string()),
            current_state: false, // 默认关闭（与 TOOL_CONTEXT7 默认状态保持一致）
